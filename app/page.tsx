...
export default function Page() {
  ...
  return (
    <div style={{ position: "relative", height: "100dvh", width: "100%", overflow: "hidden", background: "#000" }}>
      ...
      {needsPermission && (
        <div style={{ position: "absolute", inset: 0, zIndex: 100, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(0,0,0,0.8)" }}>
          <button onClick={requestOrientation} className="perm-btn">
      ...
      >
        <img src="/images/mars-1.png" alt="" style={imgStyle} />
      </div>
      ...
      >
        <img src="/images/starship.png" alt="" style={{ ...imgStyle, objectFit: "contain" }} />
      </div>
      ...
      >
        <img src="/images/mars-2.png" alt="" style={imgStyle} />
      </div>

      {/* z-5 — TEXT + UI — always on top of image layers */}
      <div
      ...
      >
        ...
        >
          <a href="https://github.com/khushc2007" target="_blank" rel="noopener noreferrer" className="icon-link" aria-label="GitHub">
          ...
          <a href="#" target="_blank" rel="noopener noreferrer" className="icon-link" aria-label="Website">
      ...
      {/* z-4 — foreground layer (behind text) */}
      <div
      ...
      >
        <img src="/images/mars-3.png" alt="" style={imgStyle} />
      </div>
